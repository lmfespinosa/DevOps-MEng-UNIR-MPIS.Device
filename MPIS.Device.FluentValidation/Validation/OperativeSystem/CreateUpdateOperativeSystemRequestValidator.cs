...
{
    public class CreateUpdateOperativeSystemRequestValidator : AbstractValidator<UpdateOperativeSystemRequest>
    {
        public CreateUpdateOperativeSystemRequestValidator()
        {
